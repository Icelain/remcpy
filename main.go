...
<head>
	...
	<style>
		@font-face {
			...
			src: url('https://ice.computer/static/GeistMono-Regular.woff2') format('woff2');
			font-weight: normal;
			font-style: normal;
			font-display: swap;
		}
		...
		@font-face {
			font-family: 'Agave';
			src: url('https://ice.computer/static/agave.woff2') format('woff2');
			font-weight: normal;
			font-style: normal;
			font-display: swap;
		}
		...
		* {
		...
		.method {
			font-weight: bold;
			font-family: 'Agave', 'Courier New', monospace;
			font-size: 1.1rem;
